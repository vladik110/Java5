...
public class ReceiptWord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField_FIO.setBounds(670, 330, 700, 30);
        ...
        jLabel1.setMinimumSize(new java.awt.Dimension(1414, 564));
        jLabel1.setPreferredSize(new java.awt.Dimension(1414, 564));
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 0, 1410, 540);

        setSize(new java.awt.Dimension(1396, 568));
